...
public class CommandCompleted extends SubMessageBody{
	private int commandingRobotID;
	private int commandID;
	public static final int ID = SubMessageBody.SubMessageBodyType.COMMAND_COMPLETED.getID();
	public static final CommandCompleted PARSER = new CommandCompleted(0, 0);


	public CommandCompleted (int commandingRobotID, int commandID) {
	...
	public CommandCompleted fromIntArray(int[] array, int offset) {
		int counter = 2 + offset;
		int commandingRobotID = array[counter+0];
		int commandID = array[counter +1];
		return new CommandCompleted(commandingRobotID, commandID);
	}
